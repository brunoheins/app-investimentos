...
# --- APP AUTENTICADO ---
    ...
    # NOVO: Menu de seleção colocado na barra lateral
    menu_selecionado = st.sidebar.radio(
        "Navegação / Painéis:",
        ["💼 Resumo da Aplicação", "📈 Evolução do Saldo", "🎯 Guia de Aportes"]
    )
    ...
    # --- CONTROLE DE TELAS DINÂMICO (Baseado no menu lateral) ---
    ...
    if menu_selecionado == "💼 Resumo da Aplicação":
        ...
        if not df_invest.empty:
            ...
            if not dados_usuario.empty:
                ...
                # Agrupando ativos duplicados e calculando preço médio ponderado
